...
<section class="pendaftaran-section py-5" style="background-color: #F8F4FF; min-height: 80hv">
    <div class="container">
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-lg-8">
                <div class="d-flex justify-content-between position-relative registration-steps">
                    ...
                    <div class="step-item active">
                        <div class="reg-step-icon-wrapper">
                            <img src="{{asset('icons/pesanan.png')}}" alt="Konfirmasi Pesanan" class="reg-step-icon active-icon">
                        </div>
                    ...
                    <div class="step-item active">
                        <div class="reg-step-icon-wrapper">
                            <img src="{{asset('icons/walet.png')}}" alt="KPembayaran" class="reg-step-icon active-icon">
                        </div>
        ...
        <div class="row justify-content-center mb-4">
            <div class="col-lg-10">
                <div class="p-4" style="background-color: #F0E8FF; border-radius: 20px;">
                    <span class="text-uppercase fw-bold text-purple" style="font-size: 0.85rem; letter-spacing: 1px;">Nomor Pendaftaran</span>
        ...
        <div class="row justify-content-center mb-4">
            <div class="col-lg-10">
                <div class="card border-0 shadow-sm p-5 text-center" style="border-radius: 20px;">
                    <div class="mb-4">
                        <img src="{{asset('images/qris.png')}}" alt="QRIS" class="img-fluid" style="max-height: 40px;">
                    </div>
                    <div class="qris-code-wrapper mx-auto" style="max-width: 250px;">
                        <img src="{{asset('images/qris_code.png')}}" alt="QRIS Code" class="img-fluid rounded shadow-sm">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-10">
                <div class="card border-0 p-4" style="border-radius: 20px; background-color: #F0E8FF;">
                    ...
                    <ol class="text-muted" style="font-size: 0.9rem; line-height: 1.8;">
                        ...
                        <li>Kembali ke halaman website dan klik tombol <strong>"Saya Sudah Bayar"</strong> setelah pembayaran selesai.</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="d-flex flex-column flex-sm-row justify-ccontent-endd- gap-3">
                    <div class="col-md-2 col-sm-3">
                        <a href="{{route('pendaftaran.step2')}}" class="btn btn-outline-purple w-100 py-2" style="border-radius: 50px; font-weight: 700;">Kembali</a>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-5">
                        <button type="button" class="btn btn-auth w-100 py-2 m-0" style="border-radius: 50px; font-weight: 700;" data-bs-toggle="modal" data-bs-target="#successModal">Saya Sudah Bayar</button>
                    </div>
                </div>
            </div>
        </div>
