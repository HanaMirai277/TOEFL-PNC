        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                <div class="tentang-content-text">
                    <p>Sistem pendaftaran TOEFL Politeknik Negeri Cilacap merupakan layanan resmi yang 
                        diselenggarakan oleh Unit Penunjang Akademik (UPA) Bahasa. Tes ini bertujuan 
                        untuk mengukur kemampuan bahasa Inggris mahasiswa sebagai salah satu persyaratan 
                        kelulusan serta untuk memenuhi kebutuhan akademik lainnya.</p>
                </div>
            </div>
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="program-card-custom">
                    ...
                    <p>TOEFL ITP merupakan tes kemampuan bahasa Inggris yang diselenggarakan secara 
                        institusional untuk memenuhi persyaratan kelulusan di Politeknik Negeri Cilacap.</p>
            ...
            <div class="col-md-6">
                <div class="program-card-custom">
                    ...
                    <p>TOEFL EPT-P merupakan tes prediksi yang dirancang untuk mengukur kemampuan bahasa 
                        Inggris mahasiswa sebagai persiapan menghadapi tes TOEFL resmi.</p>
                    <div class="badge-container">
                            <div class="badge-info">
                                <img src="{{asset('icons/time.png')}}" alt="Durasi">
                                Durasi 115 menit.
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="struktur-card">
                    <div class="struktur-icon">
                        <img src="{{asset('icons/written.png')}}" alt="Written">
                    </div>
