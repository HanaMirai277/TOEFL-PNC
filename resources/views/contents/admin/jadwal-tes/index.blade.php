...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{route('admin.jadwal-tes.create')}}" class="btn btn-sm text-white px-4 py-2 fw-bold" style="background-color: #5D16A6; border-radius: 25px;">
                ...
                <tbody class="bg-white">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{route('admin.jadwal-tes.show', $item->id)}}" class="btn btn-detail px-4">DETAIL</a>
                        </td>
                    </tr>
                    @empty
                        <tr>
