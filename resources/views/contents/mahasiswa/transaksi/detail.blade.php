            ...
            <div class="detail-card-wrapper mb-4">
                ...
                <div class="detail-card-body">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-colon">:</div>
                        <div class="detail-value">{{ tanggal_panjang($pendaftaranTes->created_at) }}
                            {{ $pendaftaranTes->created_at->format('H:i') }}</div>
                    </div>
                    <div class="detail-item">
            ...
            <div class="detail-card-wrapper mb-5">
                ...
                <div class="detail-card-body">
                    ...
                    <div class="detail-item mb-0">
                        ...
                        <div class="detail-colon">:</div>
                        <div class="detail-value">
                            {{ tanggal_panjang($pendaftaranTes->dibayar_pada) }}
                            {{ optional($pendaftaranTes->dibayar_pada)->format('H:i') ?? '-' }}
                        </div>
                    </div>
                </div>
            </div>
