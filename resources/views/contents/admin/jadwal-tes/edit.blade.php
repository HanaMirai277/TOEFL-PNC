        ...
        <div class="col-12">
            ...
            <form action="{{ route('admin.jadwal-tes.update', $jadwalTes->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="judul_tes" id="judul_tes"
                        class="form-control @error('judul_tes') is_invalid @enderror"
                        value="{{ old('judul_tes', $jadwalTes->judul_tes) }}"
                ...
                <div class="d-flex gap-2 mt-5">
                    ...
                    <button type="submit" class="btn text-white py-2 px-4 fw-bold"
                        style="background-color: #5D16A6; border-radius: 30px; font-size: 1rem;">
                        Simpan Perubahan
                    </button>

                    <a href="{{ route('admin.jadwal-tes.show', $jadwalTes->id) }}" class="btn btn-danger text-white py-2 px-4"
                        style="border-radius: 25px; font-size: 1rem; box-shadow: none;">
                        Batal
                    </a>
                </div>
            </form>
