                        ...
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form action="{{ route('pendaftaran.step1.store', $pendaftaranTes) }}" method="POST">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6 status-fields" id="prodiFields" style="display: none;">
                                        ...
                                        <select class="form-select form-control-custom" name="program_studi">
                                            <option value="" disabled 
                                                @selected($programStudi === null)>
                                                Pilih Program Studi
                                            </option>

                                            <option value="D3 Teknik Mesin" 
                                                @selected($programStudi === 'D3 Teknik Mesin')>
                                                D3 Teknik Mesin
                                            </option>

                                            <option value="D3 Teknik Listrik" 
                                                @selected($programStudi === 'D3 Teknik Listrik')>
                                                D3 Teknik Listrik
                                            </option>

                                            <option value="D3 Teknik Elektronika" 
                                                @selected($programStudi === 'D3 Teknik Elektronika')>
                                                D3 Teknik Elektronika
                                            </option>

                                            <option value="D3 Teknik Informatika" 
                                                @selected($programStudi === 'D3 Teknik Informatika')>
                                                D3 Teknik Informatika
                                            </option>

                                            <option value="D4 Teknik Pengendalian Pencemaran Lingkungan"
                                                @selected($programStudi === 'D4 Teknik Pengendalian Pencemaran Lingkungan')>
                                                D4 Teknik Pengendalian Pencemaran Lingkungan
                                            </option>

                                            <option value="D4 Akutansi Lembaga Keuangan Syariah"
                                                @selected($programStudi === 'D4 Akutansi Lembaga Keuangan Syariah')>
                                                D4 Akutansi Lembaga Keuangan Syariah
                                            </option>

                                            <option value="D4 Rekayasa Keamanan Siber" 
                                                @selected($programStudi === 'D4 Rekayasa Keamanan Siber')>
                                                D4 Rekayasa Keamanan Siber
                                            </option>

                                            <option value="D4 Pengembangan Produk Agroindustri"
                                                @selected($programStudi === 'D4 Pengembangan Produk Agroindustri')>
                                                D4 Pengembangan Produk Agroindustri
                                            </option>

                                            <option value="D4 Teknologi Rekayasa Multimedia" 
                                                @selected($programStudi === 'D4 Teknologi Rekayasa Multimedia')>
                                                D4 Teknologi Rekayasa Multimedia
                                            </option>

                                            <option value="D4 Teknologi Rekayasa Perangkat Lunak"
                                                @selected($programStudi === 'D4 Teknologi Rekayasa Perangkat Lunak')>
                                                D4 Teknologi Rekayasa Perangkat Lunak
                                            </option>

                                            <option value="D4 Teknologi Rekayasa Energi Terbarukan"
                                                @selected($programStudi === 'D4 Teknologi Rekayasa Energi Terbarukan')>
                                                D4 Teknologi Rekayasa Energi Terbarukan
                                            </option>

                                            <option value="D4 Teknologi Rekayasa Kimia Industri"
                                                @selected($programStudi === 'D4 Teknologi Rekayasa Kimia Industri')>
                                                D4 Teknologi Rekayasa Kimia Industri
                                            </option>

                                            <option value="D4 Teknologi Rekayasa Mekatronika"
                                                @selected($programStudi === 'D4 Teknologi Rekayasa Mekatronika')>
                                    ...
                                    <div class="col-md-6 status-fields" id="tahunLulusFields" style="display: none;">
                                        ...
                                        <input type="number" class="form-control form-control-custom" name="tahun_lulus"
                                            value="{{ old('tahun_lulus', $pendaftaranTes->tahun_lulus) }}" maxlength="4">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select form-control-custom" name="keperluan_tes" required>
                                            <option value="" disabled @selected($keperluanTes === null)>Pilih Keperluan</option>
                                            <option value="Syarat Kelulusan" @selected($keperluanTes === 'Syarat Kelulusan')>Syarat Kelulusan</option>
                                            <option value="Pendaftaran Kerja" @selected($keperluanTes === 'Pendaftaran Kerja')>Pendaftaran Kerja</option>
                                            <option value="Pendaftaran Studi Lanjut" @selected($keperluanTes === 'Pendaftaran Studi Lanjut')>Pendaftaran Studi Lanjut</option>
                                            <option value="Persyaratan Beasiswa" @selected($keperluanTes === 'Persyaratan Beasiswa')>Persyaratan Beasiswa</option>
                                    ...
                                    <div class="col-12">
                                        <div class="form-check custom-checkbox-wrapper">
                                            <input class="form-check-input custom-checkbox" type="checkbox" id="agree" name="agree" value="1"
                                                @checked(old('agree')) required>
                                            <label class="form-check-label ms-2" for="agree">
                                                Saya menyetujui <a href="#" data-bs-toggle="modal" data-bs-target="#termsModal" class="text-decoration-none fw-bold"
                                ...
                                <div class="d-flex justify-content-end gap-3 mt-5">
                                    <a href="{{ route('jadwal') }}" class="btn btn-outline-custom py-3">
                                        Kembali ke Jadwal
                                    </a>
                                    <button type="submit" class="btn btn-simpan py-3">
            ...
            <div class="modal-content border-0 p-3" style="border-radius: 24px;">
                <div class="modal-body p-4">
                    ...
                    <div class="terms-content mb-4" style="font-size: 0.85rem; color: #333; line-height: 1.6;">
                        <ol class="ps-3">
                            <li class="mb-2">Peserta wajib membawa kartu tes yang telah dicetak saat pelaksanaan ujian.</li>
