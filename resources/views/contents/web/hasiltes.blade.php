...
<section class="hasiltes-section">
    <div class="container">
        ...
        <!-- Kartu Hasil Utama Section-->
        <div class="hasil-utama-card mb-5">
            <div class="hasil-header">
                <img src="{{asset('icons/paper.png')}}" alt="" width="24">
                <h4 class="mb-0">Hasil Tes</h4>
            </div>
            <div class="hasil-body">
                <div class="d-flex align-items-center mb-4">
                    <div class="badge-icon">
                        <img src="{{asset('icons/test.png')}}" alt="">
                    </div>
                    <div>
                        <div class="d-flex align-items-center gap-3">
                            <h4 class="mb-0 fw-bold" style="color: #333333;">TOEFL ET-P</h4>
            ...
            <div class="info-sertifikat-body">
                <div class="row">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        <p class="info-sertifikat-desc">Sertifikat dapat diambil setelah skor TOEFL muncul pada platform TOEFL PNC.</p>
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div class="info-detail">
                                ...
                                <p class="text-muted mb-0">Ruang UPA Bahasa, Lantai2 GKB, Politeknik Negeri Cilacap.</p>
                            </div>
                        </div>

                        <div class="d-flex mb-4">
                            <div class="info-icon-wrapper">
                                <img src="{{asset('icons/time.png')}}" alt="">
                            </div>
                            <div class="info-detail">
                                <h6 class="fw-bold mb-1">Jam Kerja</h6>
                                <p class="text-muted mb-0">Senin - Juma'at <br> 08.00 - 15.30 WIB</p>
                            </div>
                        </div>

                        <div class="d-flex gap-3 flex-wrap mt-4">
                            <a href="#" class="btn btn-outline-custom d-flex align-items-center gap-2">
                                <img src="{{asset('icons/paper.png')}}" alt="" width="14">
                                Unduh Surat Pengambilan
                            </a>
                            <a href="#" class="btn btn-outline-custom d-flex align-items-center gap-2">
                                <img src="{{asset('icons/paper.png')}}" alt="" width="14">
                                Unduh Surat Kuasa
                    ...
                    <div class="col-lg-6">
                        <div class="catatan-box">
                            ...
                            <ul class="catatan-list">
                                ...
                                <li>Khusus untuk TOEFL EPT-P, jika peserta tidak bisa mengambil sendiri, dapat diwakilkan
                                    dengan membawa <strong>Surat Pernyataan Pengambilan Sertifikat</strong> (diisi oleh yang
                                    mewakili) dan <strong>Surat Pernyataan Pengambilan Sertifikat</strong> (diisi oleh orang
                                    yang namanya tertera di sertifikat).</li>
                            </ul>
                        </div>
                    </div>
                </div>
