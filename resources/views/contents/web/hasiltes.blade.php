            ...
            @else
                ...
                <div class="alert alert-info text-center py-5">
                    ...
                    <p class="text-muted mb-0">
                        Hasil tes Anda akan muncul di sini setelah diadministrasi oleh panitia TOEFL PNC.
                    </p>
                </div>
            @endif
        </div>
                    ...
                    <div class="info-sertifikat-body">
                        <div class="row">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <p class="info-sertifikat-desc">
                                    Sertifikat dapat diambil setelah skor TOEFL muncul pada platform TOEFL PNC.
                                </p>
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="info-detail">
                                        ...
                                        <p class="text-muted mb-0">
                                            Ruang UPA Bahasa, Lantai 2 GKB,<br>Politeknik Negeri Cilacap.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="catatan-box">
                                    ...
                                    <ul class="catatan-list">
                                        ...
                                        <li>
                                            Khusus untuk TOEFL EPT-P, jika peserta tidak bisa mengambil sendiri, dapat
                                            diwakilkan dengan membawa <strong>Surat Pernyataan Pengambilan Sertifikat</strong> 
                                            (diisi oleh yang mewakili) dan <strong>Surat Kuasa Pengambilan Sertifikat</strong> 
                                            (diisi oleh orang yang namanya tertera di sertifikat).
                                        </li>
                                    </ul>
                                </div>
                            </div>
