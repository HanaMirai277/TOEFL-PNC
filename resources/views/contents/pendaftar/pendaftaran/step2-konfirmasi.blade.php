...
<section class="pendaftaran-section py-5" style="background-color: #F8F4FF; min-height: 80vh;">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="row g-4">
                    <!-- Kolom Kiri: Informasi Jadwal & Data Peserta -->
                    <div class="col-md-6">
                        <!-- Informasi Jadwal TOEFL -->
                        <div class="card border-0 shadow-sm mb-4" style="border-radius: 20px;">
                            <div class="card-header py-3 px-4 d-flex align-items-center" style="border-top-left-radius: 20px; border-top-right-radius: 20px; background-color: #F0E8FF; border-bottom: 2px solid #F7B801;">
                            ...
                            <div class="card-body p-4" style="font-size: 0.8rem;">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8" style="font-weight: 400;">: Special Ramadhan Batch 1 - EPT-P</div>
                                </div>
                                <div class="row mb-3">
                    ...
                    <!-- Kolom Kanan: Ringkasan Pembayaran & Metode Pembayaran -->
                    <div class="col-md-6">
                        ...
                        <div class="card border-0 shadow-sm mb-4" style="border-radius: 20px;">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-left">
                                    <img src="{{asset('images/qris.png')}}" alt="QRIS" class="img-fluid" style="max-height: 70px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-7">
                                <a href="#" class="btn btn-auth w-100 py-2 m-0" style="border-radius: 50px; font-weight: 700;">Lanjut ke Pembayaran</a>
                            </div>
                        </div>
                    </div>
                </div>
