                        ...
                        <!-- Ganti Foto Section -->
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <input type="file" name="foto" id="foto" class="d-none" onchange="updateFileName(this)">
                                        <label for="foto" class="btn-choose-file">Choose File</label>
                                        <span class="file-name-display ms-3 text-muted" style="font-size: 14px;">No file chosen</span>
                                    </div>
                                </div>
                            </div>
                         </div>
                         ...
                         <!-- Form Fields -->
                          <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" class="form-control-custom" value="{{Auth::user()->name}}" placeholder="Masukkan nama lengkap">
                          </div>

                          <div class="mb-5">
                            <label for="name" class="form-label-custom">Email</label>
                            <input type="email" name="email" id="email" class="form-control-custom" value="{{Auth::user()->email}}" placeholder="Masukkan alamat email">
                          </div>
